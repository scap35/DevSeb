...
<ImportInfrastructure xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <VSAs/>
    <SecurityZones>
		<SecurityZone name="${zone_name}" securityZoneId="${zone_id}" vLbId="${zone_id}-${route_domain}" vrfName="${vrf_name}" fwVSI="${fw_vsi}" zoneIndex="${route_domain}" subIntRouterBack="${sub_int_router_back}" visTechnic="fce-OBS-${zone_id}-${route_domain}-vip-forwarding">
			<Networks>
