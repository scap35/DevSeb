...
# Date   : 26/06/2014
# Description :
# lire le catalogue logique pour en extraire les données CPU RAM de toutes les VMT
# dans le but de les comparer avec les données présentes dans le fichier MatrixRelease
# ------------------------------------------------------------------------------------
